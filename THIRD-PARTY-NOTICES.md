...
| [Noto Sans KR / Noto Serif KR](https://github.com/notofonts/noto-cjk) | SIL Open Font License 1.1 | 온디맨드 다운로드 후 앱이 설치한 LibreOffice 의 글꼴 폴더에 배치. HWP 가 쓰는 한컴 계열 글꼴이 없는 기계에서 한글이 깨지지 않게 하는 대체 글꼴 |
