...
- [~] 데모 UX: 드롭존·진행률·완료 흐름 {#demo-ux}
  ...
  - [x] 파일별 진행률·완료·실패 상태가 큐 리스트에 실시간 표시된다 {#progress-ui}
...
- [~] 이미지 변환 엔진 (Rust) {#img-engine}
  - [x] PNG/JPG/WebP/AVIF/BMP/TIFF 상호 변환이 매트릭스 테스트로 검증된다 {#img-basic}
...
| 2026-08-08T22:37:00+09:00 | #img-basic | claude-code | ☐→x | .oculpm/journal/20260808/Features_to_add/2236_feature_image-format-conversion-engine.md | PNG/JPG/WebP/BMP/TIFF/GIF 6×6=36 조합 매트릭스 통과 · 알파는 흰 배경 합성. AVIF 는 미포함 |
<!-- oculpm:plan-log end -->
